                                        ...
                                        <span class="order-details-data-item">
                                            <ul class="list-unstyled">
                                                ...
                                                {else}
                                                    ...
                                                    {*
                                                        Lieferzeit / voraussichtliche Zustellung in der Bestell-Detailansicht
                                                        (Mein Konto -> Bestellungen) NICHT anzeigen.

                                                        Entfernt: {lang key='shippingTime' ...}: {$Bestellung->cEstimatedDelivery}
                                                    *}
                                                {/if}
                                            </ul>
                                        </span>
                            ...
                            {col cols=12 md=6}
                                {form method="post" id='request-plz' action="{get_static_route}" class="jtl-validate" slide=true}
                                    ...
                                    {formgroup
                                        ...
                                        label={lang key='email' section='account data'}
                                    }
                                        {input
                                        type="text"
                                        name="mail"
                                        value=""
                                        id="mailaddress"
                                        class="mailaddress_input"
                                        placeholder=" "
                                        required=true
                                        autocomplete="billing mail-address"
                                    }
                                    {/formgroup}
                                    {row}
                                        {col class='ml-auto-util col-md-auto'}
                                            {button type='submit' value='1' block=true variant='primary' class='mb-3'}
                                                {lang key='view_order_details' section='global'}
                                            {/button}
                                        {/col}
                                    {/row}
                                {/form}
