                                        ...
                                        {row}
                                            {col cols=12}
                                                <dl class="form-row">
                                                    ...
                                                    {if $Einstellungen.artikeldetails.artikeldetails_hersteller_anzeigen !== 'N' && !empty($pushedArtikel->cHersteller)}
                                                        {block name='productdetails-pushed-success-manufacturer'}
